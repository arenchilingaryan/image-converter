...
worker_threads_1.parentPort.on('message', function (data) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        (0, convert_1.convert)(data.file, data.outType, data.token, function (result) {
            return worker_threads_1.parentPort === null || worker_threads_1.parentPort === void 0 ? void 0 : worker_threads_1.parentPort.postMessage(result);
        });
        return [2 /*return*/];
    });
}); });
